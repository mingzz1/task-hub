/* TaskCard — board card. Exposes window.TaskCard */
(function () {
  const { ProjectTag, DueBadge, AvatarStack, PriorityDot, PRI } = window.UI;
  const Icons = window.Icons;

  function TaskCard({ task, project, meeting, bookmarkCount, onOpen, onToggleDone, dragHandlers, dragging }) {
