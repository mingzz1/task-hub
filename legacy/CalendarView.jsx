/* CalendarView — month grid: task due dates + recurring meetings. Exposes window.CalendarView */
(function () {
  const { WD, todayDate, dayDiff, meetingOccurrencesOn } = window.UI;
  const Icons = window.Icons;
  const { useState } = React;

  function CalendarView({ state, onOpenTask, onOpenMeeting }) {
    const t = todayDate();
    ...
    const todayIso = window.AppData.today;
